...
export const AuthPage = ({
  ...
  const handleLoginSubmit = async (e: FormEvent) => {
    ...
    if (!validateEmail(email)) {
      setError("Please provide a valid Gmail address (e.g. user@gmail.com)");
      return;
    }
  ...
  const validatePhone = (phoneValue: string) => mobilePattern.test(phoneValue);
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <Link
        to="/"
        className="fixed top-6 left-6 z-50 flex items-center space-x-2 text-gray-600 hover:text-gray-900 transition-colors"
      >
            ...
            {isLogin ? (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Reduce Agra's traffic congestion while saving your daily
                    travel expenses.
                  </p>
                </div>
              ...
              >
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-gray-600 mt-2">
                    Log in to your sharing ecosystem.
                  </p>
                </div>
