...
export const SearchRides = ({ user }: { user: UserType | null }) => {
  ...
  const [counterOfferPrice, setCounterOfferPrice] = useState<number | null>(
    null,
  );
  const [showCounterOffer, setShowCounterOffer] = useState(false);
  const [pendingBookings, setPendingBookings] = useState<Set<number>>(
    new Set(),
  );
  const [selectedSorts, setSelectedSorts] = useState<Set<SortOption>>(
    new Set(["earliest"]),
  );
  ...
  return (
    <div className="flex flex-col lg:flex-row bg-gray-50 fixed inset-0 top-16">
      ...
      <aside className="hidden lg:flex lg:w-80 xl:w-96 bg-white shrink-0 border-r border-gray-200 flex-col h-full overflow-hidden">
          ...
          <div className="bg-white rounded-xl p-4 border border-gray-200">
            ...
            <div className="space-y-2">
              <button
                ...
                className="flex items-center justify-between w-full cursor-pointer group p-2 rounded-lg hover:bg-gray-50 transition-colors"
              >
                <div className="flex items-center space-x-2.5">
                  <div
                    className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${
                      selectedSorts.has("earliest")
              ...
              <button
                onClick={() => toggleSort("twoWheeler")}
                className="flex items-center justify-between w-full cursor-pointer group p-2 rounded-lg hover:bg-gray-50 transition-colors"
              >
                <div className="flex items-center space-x-2.5">
                  <div
                    className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${
                      selectedSorts.has("twoWheeler")
                        ? "border-blue-600 bg-blue-600"
                        : "border-gray-300 group-hover:border-blue-400"
                    }`}
                  >
            ...
            <div className="space-y-2">
              <div className="flex items-start space-x-2">
                ...
                <p className="text-xs text-gray-700 leading-relaxed">
                  Always check driver ratings and vehicle information before
                  booking.
                </p>
              </div>
              <div className="flex items-start space-x-2">
                ...
                <p className="text-xs text-gray-700 leading-relaxed">
                  Let friends or family know your ride details and expected
                  arrival time.
                </p>
              </div>
              <div className="flex items-start space-x-2">
                <AlertCircle className="w-3.5 h-3.5 text-green-600 shrink-0 mt-0.5" />
                <p className="text-xs text-gray-700 leading-relaxed">
                  Choose well-lit, public pickup and drop-off locations.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-3 sm:px-5 py-4 pb-20">
            ...
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-600 mt-1">
                Find commuters traveling your way in Agra
              </p>
            </div>
            ...
            {loading ? (
              ...
              <div className="space-y-3 pb-8">
                {sortedAndFilteredRides.map((ride) => {
                  ...
                  const isDisabled =
                    isFull || hasBooked || isOwnRide || hasPending;
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        >
                          <div className="w-10 h-10 rounded-full bg-linear-to-br from-gray-100 to-gray-200 flex items-center justify-center border-2 border-white shadow-sm">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center space-x-1.5 mt-0.5">
                              <StarRating
                                rating={ride.avg_rating || 5}
                                size="sm"
                              />
                              <span className="text-gray-500 text-xs font-medium">
                                {(ride.avg_rating || 5).toFixed(1)}
                              </span>
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <button
                            onClick={() =>
                              !isDisabled &&
                              setBookingRideId(isExpanding ? null : ride.id)
                            }
                            disabled={isDisabled}
                      ...
                      <div
                        className="mt-2.5 flex items-center space-x-3 cursor-pointer"
                        onClick={() => setSelectedRide(ride)}
                      >
                        <div className="flex-1 bg-gray-50 rounded-lg p-2.5">
                          <div className="flex items-center space-x-2.5">
                            <div className="flex-1">
                              ...
                              <div className="font-semibold text-sm text-gray-900">
                                <span className="lg:hidden">
                                  {truncateAddress(ride.origin, 28)}
                                </span>
                            ...
                            <div className="flex-1">
                              ...
                              <div className="font-semibold text-sm text-gray-900">
                                <span className="lg:hidden">
                                  {truncateAddress(ride.destination, 28)}
                                </span>
                                <span className="hidden lg:inline">
                                  {ride.destination}
                                </span>
                        ...
                        >
                          ...
                          {formatDistanceToNow(new Date(ride.departure_time), {
                            addSuffix: false,
                          })}
                        </div>
                      </div>
                                  ...
                                  onClick={async () => {
                                    ...
                                    await fetch("/api/messages", {
                                      ...
                                      body: JSON.stringify({
                                        ...
                                        content:
                                          "Hi! I'm interested in your ride.",
                                      }),
                                    });
                              ...
                              <div className="space-y-6">
                                ...
                                <div className="card p-6 space-y-4">
                                  <div className="flex justify-between items-center">
                                    ...
                                    <span
                                      className={`badge ${ride.available_seats === 0 ? "badge-error" : "badge-primary"}`}
                                    >
                                  ...
                                  <div className="w-full bg-gray-200 h-2 rounded-full overflow-hidden">
                                    <div
                                      className={`h-full ${ride.available_seats === 0 ? "bg-red-500" : "bg-orange-500"}`}
                                      style={{
                                        width: `${(1 - ride.available_seats / 4) * 100}%`,
                                      }}
                                    />
                                  </div>
                                      ...
                                      <button
                                        onClick={() => {
                                          ...
                                          const suggestedPrice = Math.round(
                                            ride.price_per_seat * 0.8,
                                          );
                                          setCounterOfferPrice(
                                            suggestedPrice > 0
                                              ? suggestedPrice
                                              : ride.price_per_seat - 10,
                                          );
                                        }}
