            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-16">
                ...
                <div className="flex items-center gap-1 bg-white p-1 rounded-2xl border border-slate-100 shadow-sm">
                    ...
                    <button
                        ...
                        className={`px-6 py-2 rounded-xl text-sm font-bold transition-all ${activeTab === 'rides' ? 'bg-primary text-white shadow-lg shadow-orange-200' : 'text-slate-400 hover:text-slate-600'}`}
                    >
                        All Rides
                    </button>
                    <button
                        onClick={() => setActiveTab('users')}
                        className={`px-6 py-2 rounded-xl text-sm font-bold transition-all ${activeTab === 'users' ? 'bg-primary text-white shadow-lg shadow-orange-200' : 'text-slate-400 hover:text-slate-600'}`}
                    >
                        Users
                    </button>
                    <button
                                                ...
                                                <div className="flex items-center justify-end gap-2">
                                                    ...
                                                    {ride.status === 'active' && (
                                                        <button
                                                            ...
                                                            className="px-3 py-1.5 text-xs font-bold text-emerald-600 hover:bg-emerald-50 rounded-xl transition-all"
                                                            title="Mark Complete"
                                                        >
                                                            Complete
                                                        </button>
                                            ...
                                            <td className="px-6 py-6">
                                                <div className="flex items-center justify-end gap-2">
                                                    <button
                                                        ...
                                                        className="px-3 py-1.5 text-xs font-bold text-purple-600 hover:bg-purple-50 rounded-xl transition-all"
