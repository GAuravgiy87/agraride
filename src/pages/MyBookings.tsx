...
const EmptyState = ({
  ...
  >
    ...
    >
      ...
      />
      {/* Question mark */}
      <text x="114" y="42" fontSize="14" fontWeight="bold" fill="#F97316">
        ?
      </text>
      {/* Road */}
...
const BookingCard = ({
  ...
  const rc =
    rideStatusConfig[booking.ride_status] ?? rideStatusConfig.cancelled;
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center flex-wrap gap-3 text-xs text-gray-500">
              <span className="flex items-center gap-1">
                ...
                {new Date(booking.departure_time).toLocaleDateString("en-IN", {
                  day: "numeric",
                  month: "short",
                  year: "numeric",
                })}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">
                {booking.driver_vehicle_description ||
...
export const MyBookings = ({ user }: { user: UserType | null }) => {
  ...
  const filterBookings = () => {
    ...
    if (rideStatusFilter !== "all")
      f = f.filter((b) => b.ride_status === rideStatusFilter);
    f.sort(
      (a, b) =>
  ...
  const stats = [
    ...
    {
      label: "ACTIVE",
      value: bookings.filter((b) => b.ride_status === "active").length,
      color: "#7C3AED",
