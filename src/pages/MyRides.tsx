...
const EmptyState = ({ onOffer }: { onOffer: () => void }) => (
  ...
  >
    ...
    <p className="text-gray-500 text-sm mb-8 max-w-xs">
      Start sharing your journey with the community and help others travel
      smarter.
    </p>
    <button
      onClick={onOffer}
...
const RideCard = ({
  ...
  const timeLabel = formatDistanceToNow(new Date(ride.departure_time), {
    addSuffix: true,
  });
  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        {/* Left: Car icon */}
        <div
          className="w-13 h-13 rounded-xl bg-orange-50 border border-orange-100 flex items-center justify-center shrink-0"
